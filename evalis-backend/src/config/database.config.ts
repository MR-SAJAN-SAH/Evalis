...
export const superadminDatabaseConfig: TypeOrmModuleOptions = {
  ...
  entities: [SuperAdmin, SubscriptionPlan, Admin, Organization, User, UserProfile, Exam, Question, ProgrammingQuestion, TeacherClassroom, ClassroomInvitation, CandidateClassroom, ClassroomAnnouncement],
